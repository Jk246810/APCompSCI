...
/*
0.  Call DoTiming with values of 1000, 5000, 10000.  What do you notice?
1.  Why are there overloaded versions of some of the sorts?
2.  Does it help to add a bool value to BubbleSort to stop swapping?
3.  Do the values differ on differnt computers?
4.  It took my old iBook over six minutes to BubbleSort 50000 elements.  You may want
    to comment out the Quadratic sorts for larger arrays.
5.  Add a median function to Quicksort.
6.  Experiment with the CUTOFF constant.
*/
