...
public class McCovey200000 extends GraphicsProgram
{
    ...
    public void run()
    {
        ...
        add(text);
        infoText = new GLabel("Click to play 100000 games with player A going first", 40,320);
        ...
        infoText.setLabel("Click to play 100000 games with player B going first");
        waitForClick();
        infoText.setLabel("");
        ...
        if (num1 == num2)
            ...
            infoText.setLabel("Player A wins!");
        else
            infoText.setLabel("Player B wins!");
    }
    ...
    private void updateBars()
    {
        ...
        text.setLabel("A = " + num1 + " wins, B =  " + num2 + " wins");     
    }
